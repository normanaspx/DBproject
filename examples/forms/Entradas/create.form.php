			...
			<form method="post">
				<div class="form-row">
				  <div class="form-group col-md-3">
				    ...
				    <input type="text" class="form-control" id="inputPassword4" placeholder="" name="descripcion">
					</div>
					<div class="form-group col-md-3 ">
			         <label for="inputEmail4"><strong>Cantidad</strong></label>
			         <input type="text" class="form-control" id="inputEmail4" placeholder="" name="cantidad">
			       </div>
                   <div class="form-group col-md-3 ">
			         <label for="inputEmail4"><strong>Id_producto</strong></label>
			         <input type="text" class="form-control" id="inputEmail4" placeholder="" name="id_producto">
			       </div>
                   <div class="form-group col-md-3 ">
			         <label for="inputEmail4"><strong>Id_bodega</strong></label>
			         <input type="text" class="form-control" id="inputEmail4" placeholder="" name="id_bodega">
			       </div>
			 </div> 
